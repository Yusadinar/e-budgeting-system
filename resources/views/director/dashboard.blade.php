...
<div class="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-5">
    ...
    <div class="bg-white rounded-2xl border border-slate-100 p-4 shadow-card animate-page">
        ...
        <p class="text-lg font-bold text-slate-900 leading-tight">{{ \App\Helpers\FormatHelper::rupiah($totalBudgetPlan) }}</p>
    ...
    <div class="bg-white rounded-2xl border border-slate-100 p-4 shadow-card animate-page-delay-1">
        ...
        <p class="text-lg font-bold text-slate-900 leading-tight">{{ \App\Helpers\FormatHelper::rupiah($totalBudgetUsed) }}</p>
    ...
    <div class="bg-white rounded-2xl border border-slate-100 p-4 shadow-card animate-page-delay-2">
        ...
        <p class="text-lg font-bold text-slate-900 leading-tight">{{ \App\Helpers\FormatHelper::rupiah($totalBudgetSisa) }}</p>
        <p class="text-[11px] text-slate-400 mt-0.5">Reserve: {{ \App\Helpers\FormatHelper::rupiah($totalBudgetReserved) }}</p>
    </div>
